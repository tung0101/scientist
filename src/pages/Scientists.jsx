          ...
          <div className="w-full h-fit bg-[#2F3338] rounded-xl shadow-md overflow-hidden md:max-w-6xl mb-10 p-4">
            <div>
              <div className="border-b-2 border-[#959799] pb-4">
                <div className="grid grid-cols-4 gap-4"> <div className="col-span-1">
                  <img
                    alt=''
                  ...
                  <div className="col-span-3">
                    <div className="flex items-start justify-between uppercase tracking-wide text-xl">
                      <div>
                        ...
                        <a href="/" className="block mt-1 text-sm pb-3 leading-tight font-medium text-slate-500 hover:underline">@Leonel Messi</a>
                      </div>
                      <div>
                        <p className="text-xs font-semibold mt-1">NFT, Technology, Medical, Web3</p>
                      </div>
                    </div>
        ...
        <div className="h-24 rounded-2xl mb-4 bg-[#2F3338] p-3">
          <div className="flex gap-2">
            ...
            <div className="grid-cols-1">
              <span className="text-base">Specialized T Cells Patrol Human Cornea</span>
            </div>
