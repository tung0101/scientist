          ...
          <div className="rounded-lg">
                  ...
                  <div className="ml-2.5 mb-3">
                    <span className="opacity-50  font-normal text-sm">
                      ...
                      In a new <a className="underline font-bold text-text-blue decoration-text-text-blue-900 cursor-pointer">study</a>. published in Nature, <a className="underline font-bold text-text-blue decoration-text-text-blue-900  cursor-pointer">Sergiu Pașca,</a> a neuroscientist at Stanford University, and his team combined assembloid technology with CRISPR gene editing to determine the role of neurodevelopmental disease genes during typical brain development and the mayhem that ensues when they are missing.1
                    </span>
                  </div>

                  <div className="ml-2.5 mb-3">
                    <span className="opacity-50  font-normal text-base">
                    See also <a className="underline font-bold text-text-blue decoration-text-text-blue-900  cursor-pointer">“Sergiu Pasca Builds Brains to Study Developmental Disease”</a>  
                    </span>
                  </div>
