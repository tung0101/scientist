          ...
          <div className=" w-[439px] flex flex-col items-center">
            ...
            <div className="w-full h-[75px] gap-[8px]">
              ...
              <div className="flex items-center relative">
                <input className="w-[439px] h-[48px] rounded-[8px] py-[12px] px-[16px] bg-[#3F444E]" placeholder="Password" />
                <FontAwesomeIcon
                  icon={faEye}
                  className=" absolute right-[20px] text-[#858D9D]"
                />
              </div>
            </div>
            ...
            <div className="w-full h-[75px] gap-[8px] mt-[40px]">
              ...
              <div className="flex items-center relative">
                <input className="w-[439px] h-[48px] rounded-[8px] py-[12px] px-[16px] bg-[#3F444E]" placeholder="Passowrd" />
                <FontAwesomeIcon
                  icon={faEye}
                  className=" absolute right-[20px] text-[#858D9D]"
                />
            ...
            {/* btn */}
            <div className="w-[400px] h-[50px] rounded-[8px] py-[14px] px-[16px] gap-[10px] bg-[#6F49FD] mt-[40px] m-auto">
