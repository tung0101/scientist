      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="w-full h-full gap-6 col-span-1">
          ...
          <div className="bg-[#2F3338] w-full h-fit rounded-lg gap-3 border-[1,0,0,0]">
            <div className="flex gap-3 items-center p-3">
              ...
              <div>
                <h2 className="flex mb-2 text-base">Aparna Nathan, PhD</h2>
        ...
        <div className="col-span-2 w-full h-fit rounded-lg p-2 gap-3 bg-[#2F3338]">
          <div className="bg-[#3F444E] w-full h-20 p-2 gap-2 rounded-lg flex flex-row justify-between items-center cursor-pointer ">
            <div
              className={`w-full h-16 rounded-lg gap-2 px-6 py-3 flex justify-center items-center hover:bg-[#2F3338] ${
                page === true ? "bg-[#2F3338]" : ""
              }`}
            ...
            <div
              className={`w-full h-16 rounded-lg gap-2 px-6 py-3 flex justify-center items-center cursor-pointer hover:bg-[#2F3338] ${
                page === false ? "bg-[#2F3338]" : ""
              }`}
              ...
              <div className="px-6">
                ...
                <div>
                  <p className="w-full h-fit font-normal text-base tracking-[0.5%] leading-5 opacity-[32%]">
                    Pașca’s team generated more than 1,000 organoids mimicking
                    the parts of the forebrain where interneurons begin and end
                    their journey: the subpallium and the cortex. In each
                    subpallium organoid, they used CRISPR gene editing
                    technology to eliminate one of 425 neurodevelopmental
                    disorder genes curated by the researchers. Then they
                    generated assembloids by fusing gene-edited subpallium
                    organoids with cortex organoids. By labeling the
                    interneurons with a molecule that emits green light, they
                    could track interneuron generation and movement between the
                    two halves of the assembloid.
                  </p>
