        ...
        <div className="w-[499px] h-[462px] rounded-[12px] py-[40px] px-[30px] gap-[10px] bg-[#2F3338]">
          <div className=" w-[439px] h-[382px] gap-[30px]">
            ...
            <Link to="/reset-password">
              <div className="mx-auto w-[400px] h-[50px] rounded-[8px] py-[14px] px-[16px] gap-[10px] bg-[#6F49FD] cursor-pointer hover:bg-[#9176f1]">
            ...
            <div className="mx-auto w-[400px] h-[50px] rounded-[8px] py-[14px] px-[16px] gap-[10px] border-[#E8E8E8] border-[1px] border-solid mt-[20px] cursor-pointer hover:bg-[#403e43]">
              <p className="w-[123px] h-[20px] font-[500] text-[16px] leading-[20px] capitalize m-auto text-white">
                Back to Sign in
              </p>
            </div>
            ...
            <div className=" flex items-center justify-center m-auto w-[324px] h-[19px] my-[20px]">
              <p className="text-[16px] font-[500] text-[#fff] cursor-pointer hover:underline">
                Already have an account?{" "}
              </p>
              <span className="text-[16px] font-[700] text-[#fff] opacity-[80%] ml-1 cursor-pointer hover:text-[#6F49FD]">
                Create account
              </span>
            </div>
          </div>
