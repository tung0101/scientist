        ...
        <div>
          {textBox.map((item, index) => (
            <div
              ...
              key={index}
              className={`w-full h-fit cursor-pointer rounded-lg hover:bg-[#252F3C] p-4 mb-2 ${
                active === item.id ? "bg-[#252F3C]" : ""
              }`}
            >
                  ...
                  <div className="flex items-center justify-between">
                    <p
                      className={`text-xs font-normal ${
                        index === 0 || index === 1 ? "text-blue-600" : ""
                      }`}
                    >
                      {item.text}
                    </p>
                    <div
                      className={`w-4 h-4 bg-[#4476D9] rounded-full flex items-center justify-center ${
                        index === 0 || index === 1 ? "block" : "hidden"
                      }`}
                    >
              ...
              <div className="w-56 flex items-center gap-4">
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center gap-1">
                    <div
                      className={`w-2 h-2 bg-green-500 rounded-full flex items-center justify-center`}
                    ></div>
                ...
                <div className="flex justify-end mb-10">
                  <div className="col-span-1 w-1/2 h-fit bg-[#3F444E] rounded-s-xl rounded-t-xl">
                    <div className="px-4 py-3">
                      Hi Marvin is there any update on the filing? I want to get
                      this moving fast.
                    </div>
                  </div>
                </div>
