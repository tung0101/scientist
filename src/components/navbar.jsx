...
const Navbar = () => {
    return(
        ...
        <div className='flex items-center justify-between rounded-xl  border-solid border-2 bg-white text-black w-24 px-2 py-2'>
          <button className='flex justify-between items-center font-semibold w-24 mr-4'>
        ...
        <div className="flex gap-3">
          <button className="bg-[#6F49FD] rounded-xl w-40 font-medium text-white text-xs shadow-inner shadow-current">
            <span>
              Connect To Wallet
            </span>
          </button>
          <button className="bg-[#959799] rounded-xl w-40 font-medium text-white text-xs shadow-inner shadow-current">
            <span>
              Login with Scientist
            </span>
          </button>
        </div>
